      ...
      >
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a className="text-primary text-base font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase">
                Teech
              </a>
            </Link>
            <button
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <Link href="/auth/login">
                  <a
                    className="font-medium px-4 py-2 hover:font-semibold focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3"
